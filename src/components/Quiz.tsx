...
export default function Quiz({ subtemaId, subtemaTitle, viewMode, onClose }: QuizProps) {
  ...
  useEffect(() => {
    ...
    if (progress.quizLevel === 'intermediate' || progress.quizLevel === 'advanced' || progress.quizLevel === 'completed') {
      setCurrentLevel('basic'); // Siempre empezar desde básico
    }
  }, [subtemaId]);
  ...
  const startQuiz = (level: Difficulty) => {
    ...
    if (loadedQuestions.length === 0) {
      // Si no hay preguntas para este subtema, usar preguntas genéricas
            ...
            {state === 'intro' && (
              ...
              >
                ...
                <p className={`mb-6 ${
                  ...
                  Responde 5 preguntas para avanzar de nivel. Necesitas 4/5 para desbloquear el siguiente nivel.
                </p>
