...
export interface SubtemaMetadata {
  ...
  // Modo Intuitivo (analogías y narrativa)
  modoIntuitivo?: {
    ideaCentral: string;
    imagenMental: string;
    funciones: Array<{
    ...
    nombresEspeciales?: Array<{
      tejido: string;
      nombre: string;
      funcion: string;
    }>;
    curiosidadAnclaje: string;
  };
  
  // Modo Precisión (técnico y estructurado)
  modoPrecision?: {
    esquemaFlujo: string;
    piezasClave: Array<{
      nombre: string;
    ...
    casosEspeciales?: Array<{
      tejido: string;
      detalle: string;
    }>;
    resumenMental: string[];
    retoMental: {
      pregunta: string;
      respuesta: string;
    };
